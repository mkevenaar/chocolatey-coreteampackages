...
$alreadyInstalled = (AlreadyInstalled -product $softwareName -version '149.0')
...
$packageArgs = @{
  ...
  ChecksumType = 'sha512'
  Url = "https://download.mozilla.org/?product=thunderbird-149.0&os=win&lang=${locale}"
...
if (!(Get-32bitOnlyInstalled($softwareName)) -and (Get-OSArchitectureWidth 64)) {
  ...
  $packageArgs.Url64 = "https://download.mozilla.org/?product=thunderbird-149.0&os=win64&lang=${locale}"
}
