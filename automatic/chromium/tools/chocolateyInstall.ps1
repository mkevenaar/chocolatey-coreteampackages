...
$version = '149.0.7789.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1613437/mini_installer.exe'
  checksum      = '49C8CA52313EABD4C83734381D8B8A2DE173553F8CDAA30413FDAD7716CF2E8C'
  checksumType  = 'sha256'
