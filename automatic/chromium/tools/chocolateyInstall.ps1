...
$version = '149.0.7810.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1619534/mini_installer.exe'
  checksum      = '0CD752B9CE914663C95CDEBEE163045C773E00400E526135B7B9BF9D6902C8C9'
  checksumType  = 'sha256'
