...
$version = '148.0.7744.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1602399/mini_installer.exe'
  checksum      = '6425F19FDAF5A99DFCD4ADCA700DD06D800BCA6D1ABD2538DBF1EBBB3E81FF32'
  checksumType  = 'sha256'
