...
$version = '149.0.7809.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1619395/mini_installer.exe'
  checksum      = '660E095EF304661C42F85607B362F6719EAE350983C7DAA92C014A1EFAAEFA26'
  checksumType  = 'sha256'
