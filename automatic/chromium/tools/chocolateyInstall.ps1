...
$version = '149.0.7795.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1615134/mini_installer.exe'
  checksum      = 'BCF7F04AB16053D0A9C8F5993B24DFC9B5748BFCEF3D6F3BDB90EC29AF888940'
  checksumType  = 'sha256'
