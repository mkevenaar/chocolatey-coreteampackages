...
$version = '149.0.7814.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1621507/mini_installer.exe'
  checksum      = '197582EF2641CF7E4C793182741008D424DFFEA92E4DB2EB5E14A415AB7FE0DF'
  checksumType  = 'sha256'
