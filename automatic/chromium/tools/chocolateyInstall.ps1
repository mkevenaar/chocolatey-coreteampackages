...
$version = '148.0.7763.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1606830/mini_installer.exe'
  checksum      = '133A7242BC75F5C13CB9ED6EEE1C28FE6C24BAF185A3300FDD49D099C441B73E'
  checksumType  = 'sha256'
