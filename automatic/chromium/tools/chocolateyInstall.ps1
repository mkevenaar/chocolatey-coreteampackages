...
$version = '149.0.7802.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1617284/mini_installer.exe'
  checksum      = '1ED9234D7EE7B0031AE5B400D342845E6BD4767469BB06E285C6CAF17638B356'
  checksumType  = 'sha256'
