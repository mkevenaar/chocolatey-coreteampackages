...
$version = '148.0.7767.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1608014/mini_installer.exe'
  checksum      = '2624360B6CE0AAC0CC3BC4C1F4EC87636240A335FD9DD2C7CBC0E16B3095FBB7'
  checksumType  = 'sha256'
