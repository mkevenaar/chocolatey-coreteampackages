...
$version = '148.0.7749.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1603172/mini_installer.exe'
  checksum      = 'FD0099E457AC7935F588126707385C63CF846D02A83F37522EB8E00AC6CBF5C8'
  checksumType  = 'sha256'
