...
$version = '148.0.7775.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1610164/mini_installer.exe'
  checksum      = 'F61446630B5D9A90F49C5ABA8C39A4309F52426BA8906D01854165C976547C16'
  checksumType  = 'sha256'
