...
$version = '149.0.7788.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1613349/mini_installer.exe'
  checksum      = '511AEF33C40BB433564E6EF62B39CAFECF04779A8752C3178FCFE857F322C0D7'
  checksumType  = 'sha256'
