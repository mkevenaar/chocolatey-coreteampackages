...
$version = '149.0.7797.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1615823/mini_installer.exe'
  checksum      = '9688A87CFD56CC72E386E43342C623B4B476EACACA0C43A5019F49B21C9854AC'
  checksumType  = 'sha256'
