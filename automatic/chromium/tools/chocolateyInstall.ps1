...
$version = '149.0.7799.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1616745/mini_installer.exe'
  checksum      = 'FAAFC0092E79C99D30B18000B0D58704261E10F9824DA999884955242EE355AB'
  checksumType  = 'sha256'
