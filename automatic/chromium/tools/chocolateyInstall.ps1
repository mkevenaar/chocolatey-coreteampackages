...
$version = '148.0.7741.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1601281/mini_installer.exe'
  checksum      = '8992E581E4EF901987972CE341C987FDF60F0AAC7A228C0D2DE52EFD5D917130'
  checksumType  = 'sha256'
