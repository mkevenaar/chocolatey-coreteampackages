...
$version = '149.0.7804.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1617959/mini_installer.exe'
  checksum      = '9E6AF897AD2239F9DA4A53C12D4AFAE7C56D9372140F1C71CE31AA636B82D7A2'
  checksumType  = 'sha256'
