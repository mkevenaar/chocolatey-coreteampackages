...
$version = '149.0.7807.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1618731/mini_installer.exe'
  checksum      = '6BC1C72607AA5FECA71B69EDFF17136E6DD0904ADF9BF1EC9AF1DB7CBC331F0E'
  checksumType  = 'sha256'
