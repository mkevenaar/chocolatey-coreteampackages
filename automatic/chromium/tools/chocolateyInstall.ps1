...
$version = '149.0.7785.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1612909/mini_installer.exe'
  checksum      = 'ACB2F393FA4170FDBB2142C94E88FE588B597D99DF499E19A000D4D47A79427C'
  checksumType  = 'sha256'
