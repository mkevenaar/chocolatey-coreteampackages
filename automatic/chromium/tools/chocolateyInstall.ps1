...
$version = '149.0.7780.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1611303/mini_installer.exe'
  checksum      = 'CD0CC9C1BE15EA5F62127C71D2267BD7107CCA4676E703B8CC2D28AF2B3909E7'
  checksumType  = 'sha256'
