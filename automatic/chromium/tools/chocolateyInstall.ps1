...
$version = '149.0.7796.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1615606/mini_installer.exe'
  checksum      = '02BAAAE1ED6998E5B1460C6E28497F3B9CB655201EC6819D12056345EC452103'
  checksumType  = 'sha256'
