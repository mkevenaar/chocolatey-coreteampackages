...
$version = '149.0.7805.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1618065/mini_installer.exe'
  checksum      = '5D5D14DCEEE65C013239AFD3DD6437A858B52B2B01F856EF9366F50913A664A8'
  checksumType  = 'sha256'
