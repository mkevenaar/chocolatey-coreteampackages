...
$version = '149.0.7806.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1618242/mini_installer.exe'
  checksum      = 'F5EAE0FBCC731206910586A32960B6B63B9E8CDA675317B805B213430F4A1089'
  checksumType  = 'sha256'
