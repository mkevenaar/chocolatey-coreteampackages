...
$version = '149.0.7812.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1620429/mini_installer.exe'
  checksum      = 'ABD3DBDD9A0F82DD21FC5B21F4CBEC3A77C886836127293931F1A35BBAD022C2'
  checksumType  = 'sha256'
