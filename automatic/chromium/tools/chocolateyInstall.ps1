...
$version = '148.0.7764.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1606963/mini_installer.exe'
  checksum      = 'CD4932B219C324597A26DC89B38938B4674302D744DD91C0E92FBF1110D9FB13'
  checksumType  = 'sha256'
