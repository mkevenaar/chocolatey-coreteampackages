...
$version = '149.0.7816.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1622225/mini_installer.exe'
  checksum      = '5480EA41F5EC4597F923C8A0C9D6184A9EC550DAE6D70F75CEE8F2F5BC1DC73B'
  checksumType  = 'sha256'
