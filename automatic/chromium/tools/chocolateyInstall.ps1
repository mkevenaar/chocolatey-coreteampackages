...
$version = '149.0.7794.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1615053/mini_installer.exe'
  checksum      = '9DDAF51D224FFA6C53EA765438E10C4EC4EB2D167418428D9782DACDE6B38C2C'
  checksumType  = 'sha256'
