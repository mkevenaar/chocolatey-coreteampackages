...
$version = '149.0.7783.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1612215/mini_installer.exe'
  checksum      = 'D6E74784C58CABEA5BCFD99DEC94A45FF6E36CD2E067E35B4BFFCAC696932BAE'
  checksumType  = 'sha256'
