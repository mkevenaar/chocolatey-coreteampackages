...
$version = '148.0.7766.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1607619/mini_installer.exe'
  checksum      = 'C145ED2DC533E43444D2AD9F0FB399C5DDC2AD28E5C052D20553C3502A0F3DBF'
  checksumType  = 'sha256'
