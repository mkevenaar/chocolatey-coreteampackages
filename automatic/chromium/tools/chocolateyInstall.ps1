...
$version = '148.0.7743.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1601914/mini_installer.exe'
  checksum      = '5EC0F023C226A5C9F18E12818FA2FE97CCB63ABA4F2D1186341FD95C2B9A3CFE'
  checksumType  = 'sha256'
