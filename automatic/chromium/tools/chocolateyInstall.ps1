...
$version = '148.0.7745.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1602623/mini_installer.exe'
  checksum      = '7D02BB71F65E212565CFB935BECD442F1E3857AF8526EB9760C4500DDD25A8FD'
  checksumType  = 'sha256'
