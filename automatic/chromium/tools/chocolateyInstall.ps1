...
$version = '148.0.7755.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1604831/mini_installer.exe'
  checksum      = 'EB28EF44C3FBCFCFCA96F17C3ED8DE2DB4583C478FFF183D182580B591A569C7'
  checksumType  = 'sha256'
