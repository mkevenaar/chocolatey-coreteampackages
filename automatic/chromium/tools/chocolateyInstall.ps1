...
$version = '148.0.7761.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1606718/mini_installer.exe'
  checksum      = 'F14F4FD16B9FD709005C98EDB4F3269DFA42A1DB5E9ED7102617F244910E08A3'
  checksumType  = 'sha256'
