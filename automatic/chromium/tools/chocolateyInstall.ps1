...
$version = '149.0.7782.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1612087/mini_installer.exe'
  checksum      = 'CAC621172ED56CB7EBED41384A788AA1B32AD9B9BB050EB3FD0396D393387F8D'
  checksumType  = 'sha256'
