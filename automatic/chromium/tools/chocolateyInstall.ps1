...
$version = '149.0.7784.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1612588/mini_installer.exe'
  checksum      = '0C68EC2D3E288C135BE4DD91ACD91F1F275460550D81BE720E7528CFD4C74461'
  checksumType  = 'sha256'
