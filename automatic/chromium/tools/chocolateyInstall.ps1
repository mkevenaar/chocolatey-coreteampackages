...
$version = '148.0.7736.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1599764/mini_installer.exe'
  checksum      = '167D7BD5ABAE0333A9890835BA54EE16EB1907B548C16D9CFC563A97C5391812'
  checksumType  = 'sha256'
