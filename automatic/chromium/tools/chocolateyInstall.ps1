...
$version = '148.0.7769.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1608968/mini_installer.exe'
  checksum      = '8C7F57B0887C635B2F21383DAC2074FF659C1B58A9A72A070AFE139267171353'
  checksumType  = 'sha256'
