...
$version = '149.0.7817.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1622387/mini_installer.exe'
  checksum      = '00604875A77FA9B7FE879988CEA0D172BB9B1610D840F3845C34C656C45E6326'
  checksumType  = 'sha256'
