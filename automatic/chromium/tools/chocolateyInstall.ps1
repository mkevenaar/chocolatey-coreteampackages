...
$version = '149.0.7793.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1614537/mini_installer.exe'
  checksum      = '1B554771B0177AF08D5FD968C4ACF47D588D79FAF56FDF971A3978202CAC74E0'
  checksumType  = 'sha256'
