...
$version = '149.0.7815.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1622058/mini_installer.exe'
  checksum      = '6160DD91DA4FBB2112AF580F9DBE4D3D229BF29AE48A839595DF38D1F1360C94'
  checksumType  = 'sha256'
