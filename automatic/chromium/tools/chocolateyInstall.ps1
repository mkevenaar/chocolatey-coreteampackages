...
$version = '148.0.7748.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1603108/mini_installer.exe'
  checksum      = '24050969EF2A77697AD078DDFFBF0F4844ACC6794D91EF2F6C12FC8DB992295C'
  checksumType  = 'sha256'
