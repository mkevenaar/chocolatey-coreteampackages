...
$version = '148.0.7773.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1610104/mini_installer.exe'
  checksum      = '5996CD935A9F5247520EBAACA9FD4F54F97617AC950465BDB52E2E1A1B120F98'
  checksumType  = 'sha256'
