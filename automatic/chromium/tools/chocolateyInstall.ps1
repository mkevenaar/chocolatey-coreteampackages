...
$version = '149.0.7813.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1621297/mini_installer.exe'
  checksum      = '590B3A7C10E639953D047CB3BA60E580C50801556B4B3269C58DC9236D527C95'
  checksumType  = 'sha256'
