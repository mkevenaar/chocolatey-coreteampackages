...
$version = '148.0.7750.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1603233/mini_installer.exe'
  checksum      = 'FD2525DCABDC3F93F8ADF7EF7C4066AE395EAA77D7DAB0118109B20B48290D9C'
  checksumType  = 'sha256'
