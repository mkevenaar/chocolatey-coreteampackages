...
$version = '148.0.7762.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1606774/mini_installer.exe'
  checksum      = 'A65D79E2F3F4EF8584ACCD6144B28F25E8E26B416A1FF3421EE7B241030F8712'
  checksumType  = 'sha256'
