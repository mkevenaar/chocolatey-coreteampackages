...
$version = '148.0.7746.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1602969/mini_installer.exe'
  checksum      = '19BB05557BEFE499C5F09EF3EAE7C22D96FD7AF064DC341A88C74E8EE4B17DA1'
  checksumType  = 'sha256'
